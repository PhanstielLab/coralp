        ...
        fluidRow(width=12, 
                 column(8,   
                        div(
                            ...
                            highlight specific phosphatase branches of interest using Manual, or color a selection of branches 
                            according to a categorical or quantitative color palette. Categorical coloring allows
                            you to assign phosphatases to categories, each of which will be assigned a unique color from 
        ...
        fluidRow(width=12,
                 column(8,     
                        div(
                            ...
                            "This option allows you to highlight branches to specific phosphatases of interest. 
                            It is useful for finding and emphasizing a single subset of phosphatases.",
                            ...
                            fluidRow(width=12,
                                     ...
                                     column(9,
                                            div(  
                                             ...
                                             h4 (HTML("\u2609&nbsp; Browse")),
                                             "Creates a scrollable and searchable list of all phosphatases featured on the tree. 
                                             This feature is most useful when highlighting a small number of phosphatases. Note, you can select between 
                                             lists of several different identifiers using the 'Identifier' selector (see below).",
                              
                                             h4 (HTML("\u2609&nbsp; Paste")),
                                             "Creates a field into which you may type or paste a list of phosphatases, with each phosphatase on its own line. 
                                             This feature is useful when highlighting a larger number of phosphatases, or if you 
                                             have a pre-existing list of phosphatases from a spreadsheet or other document.",
                              
                                             h3 ("Phosphatases"),
                                             "This is the field where you may select or input your list of phosphatases to highlight, 
                                             depending on your chosen input method.",
                            
                                             h3 ("Identifier"),
                                             "Phosphatases can be listed or selected by either their coralID, uniprot, ensemble, entrez, 
                                             or HGNC ID. In order to properly plot your selected branches, you must specify the 
                                             identification used in the 'Phosphatases' field.",
                            
                                             h3 ("Default Color & Selection Color"),
                                             "Here you can change branch colors for both your selected and unselected phosphatases. 
                                             Default Color sets the color of phosphatases that were not listed, while Selection Color 
                                             sets the color of the phosphatases you have identified and wish to highlight. 
                                             ...
                                             selected and unselected phosphatases. By default, the legend will refer to these two 
        ...
        fluidRow(width=12, 
                 column(8,    
                        div(
                            ...
                            "This option allows you to color phosphatase branches different colors according to user-defined 
                            category assignments. It is a useful option when trying to differentiate between multiple categories 
                            such as phosphatase families.",
                            tags$br(),tags$br(),
                            ...
                            fluidRow(width=12,
                                     ...
                                     column(9,
                                            div(  
                                             h4 (HTML("\u25ce&nbsp; Load default phosphatase groups")),
                                             "This button will load the default phosphatase groups as defined by Manning et al 2002 into the 
                                             'Phosphatases & Group' field. These groups include AGC, CAMK, CK1, CMGC, RGC, STE, TK, and TKL, 
                                             as well as Atypical and Others which fall outside of those group assignments.",
                         
                                             h3 ("Phosphatases & Category"),
                                             "Here you can submit a two-column list of phosphatases and their category assignments. A space, 
                                             tab, or new line must separate each phosphatase from its corresponding category assignment. 
                                             Every phosphatase listed must have a category assignment, or plotting will fail. Including 
                                             phosphatases with more than one category assignment will result in that phosphatase being colored 
                                             according to the last category listed alphabetically. Identifiers not found within the tree 
                                             will be ignored. phosphatases that are not listed will be colored the accoring to Default Color 
                                             (see below) and excluded from the figure legend.",
                         
                                             h3 ("Identifier"),
                                             "Phosphatases can be listed or selected by either their coralID, uniprot, ensemble, entrez, 
                                             or HGNC ID. In order to properly plot your selected branches, you must specify the 
                                             identification used in the 'Phosphatases & Category' space.",
                                             ...
                                             h3 ("Default Color"),
                                             "This option allows you to select a color for phosphatases that were not listed in the 'Phosphatases & Category' field
        ...
        fluidRow(width=12, 
                 column(8, 
                        div(
                            ...
                            "This option allows you to color phosphatase branches based on a range of quantitative values. It is 
                            ...
                            fluidRow(width=12,
                                     ...
                                     column(9,        
                                            div(
                                                ...
                                                "Here you can submit a two-column list of phosphatases and their associated values. A space, 
                                                tab, or new line must separate each phosphatase from its corresponding value. Every phosphatase listed 
                                                must have a value, or plotting will fail. Listing the same phosphatase multiple times with different 
                                                values will result in the branch being colored according to the last listed value. 
                                                Identifiers not found within the tree will be ignored. phosphatases that are not listed will be 
                                                colored according to the 'Color Missing phosphatase' settings (see below).",
                                                ...
                                                "By default, phosphatases that were not listed in the 'Phosphatases & Value' field will be automatically 
                                                ...
                                                which will bring up a 'Missing phosphatase Color' selector where you can use the color picker box to find 
