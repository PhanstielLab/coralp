        ...
        fluidRow(width=12, 
                 column(8,   
                        div(
                            ...
                            "This option dictates whether the nodes for phosphatase families and sub-families on the Circle 
                            ...
                            highlight specific phosphatases of interest using Manual, or color a selection of nodes according to a 
                            categorical or quantitative color palette. Categorical coloring allows you to assign phosphatases 
...
# NONE
                            ...
                            "This option will disable nodes from the tree altogether, showing only phosphatase identifiers at the ends of 
                            ...
                            phosphatase labels the same color as the branches.",                 
...
# UNIFORM
                            ...
                            you prefer the appearance of nodes for each phosphatase but do not wish to present any data on 
        ...
        fluidRow(width=12,
                 column(8,     
                        div(
                            ...
                            "This option allows you to highlight the nodes of specific phosphatases of interest. It is useful 
                            for finding and emphasizing a single subset of phosphatases.",
                            ...
                            fluidRow(width=12,
                                     ...
                                     column(9,
                                            div(  
                                             h3 ("Input Method"),
                                             "Here you can select the method you would like to use to identify phosphatases of interest.",
                       
                                             h4 (HTML("\u2609&nbsp; Browse")),
                                             "This method creates a scrollable and searchable list of all phosphatases featured on the tree. This feature is most useful 
                                             when highlighting a small number of phosphatases. Note, you can select between lists of several different identifiers using 
                                             the 'Identifier' selector (see below).",
                      
                                             h4 (HTML("\u2609&nbsp; Paste")),
                                             "This method creates a field into which you may type or paste a list of phosphatases, with each phosphatase on its own line. 
                                             This feature is useful when highlighting a larger number of phosphatases, or if you have a pre-existing list 
                                             of phosphatases from a spreadsheet or other document.",
                     
                                             h3 ("Phosphatases"),
                                             "This is the field where you may select or input your list of phosphatasess to highlight, 
                                             depending on your chosen input method.",
                       
                                             h3 ("Identifier"),
                                             "Phosphatasess can be listed or selected by either their coralID, uniprot, ensemble, entrez, or HGNC ID. 
                                             ...
                                             "Here you can change node colors for both your selected and unselected phosphatasess. Default Color sets 
                                             the color of phosphatasess that were not listed, while Selection Color sets the color of the phosphatasess you 
                                             ...
                                             phosphatasess. By default, the legend will refer to these two categories as 'selected' and 'not selected'. 
        ...
        fluidRow(width=12, 
                 column(8,    
                        div(
                            ...
                            "This option allows you to color phosphatases nodes different colors according to user-defined group assignments. 
                            It is a useful option when differentiating between multiple categories, such as different 
                            phosphatasess families.",
                            tags$br(),tags$br(),
                            ...
                            fluidRow(width=12,
                                     ...
                                     column(9,
                                            div(  
                                                ...
                                                h3 ("Phosphatases & Category"),
                                                "Here you can submit a two-column list of phosphatases and their category assignments. A space, tab, or new line 
                                                must separate each phosphatase from its corresponding category assignment. Every phosphatase listed must have a category 
                                                assignment, or plotting will fail. Including phosphatases with more than one category assignment will result in 
                                                that phosphatase being colored according to the last category listed alphabetically. Identifiers not found within 
                                                the tree will be ignored. phosphatases that are not listed will be colored gray and excluded from the 
                                                figure legend.",
                         
                                                h3 ("Identifier"),
                                                "Phosphatases can be listed or selected by either their coralID, uniprot, ensemble, entrez, or HGNC ID. 
                                                In order to properly plot your selected nodes, you must specify the identification used in the 
                                                'Phosphatases & Category' space.",
                                                ...
                                                automatically expand to accommodate as many categories as you have identified in the 'Phosphatases & Category' field.",
                                                ...
                                                h3 ("Color Missing Phosphatases"),
                                                "This option allows you to select a color for phosphatases that are not listed in the 'Phosphatases & Value' field
        ...
        fluidRow(width=12, 
                 column(8, 
                        div(
                            ...
                            "This option allows you to color phosphatase nodes based on a range of quantitative values. It is useful 
                            ...
                            fluidRow(width=12,
                                     ...
                                     column(9,        
                                            div(
                                                ...
                                                "This button will load sample data into the 'Phosphatases & Value' field.",
                     
                                                h3 ("Phosphatases & Value"),
                                                "Here you can submit a two-column list of phosphatases and their associated values. A space, tab, 
                                                or new line must separate each phosphatase from its corresponding value. Every phosphatase listed must 
                                                have a value, or plotting will fail. Listing the same phosphatase multiple times with different values 
                                                will result in the node being colored according to the last listed value. Identifiers not found 
                                                within the tree will be ignored. Phosphatases that are not listed will be colored according to the 
                                                'Color Missing Phosphatase' settings (see below).",
                         
                                                h3 ("Identifier"),
                                                "Phosphatases can be listed or selected by either their coralID, uniprot, ensemble, entrez, or HGNC ID. 
                                                In order to properly plot your selected nodes, you must specify the identification used in 
                                                the 'Phosphatases & Category' field.",
                                                ...
                                                h3 ("Color Missing Phosphatases"),
                                                "By default, phosphatases that were not listed in the 'Phosphatases & Value' field will be automatically colored 
                                                according to the lowest (in sequential or 2-color palettes) or middle value 
                                                (in divergent or 3-color palettes). You can opt to instead color these missing phosphatases manually, 
                                                which will bring up a 'Missing Phosphatase Color' selector where you can use the drop-down box to find a 
                                                color or enter a hex value.",
                                                tags$br(),
                                                tags$br(),
                                                tags$br()
