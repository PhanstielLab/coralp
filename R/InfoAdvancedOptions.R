...
# FONT    
                        div(
                            h2 (HTML("Labels &nbsp;\u2609")),
                            "This tab allows you to change global font settings as well as phosphatase label colors. Font style 
                            ...
                            fluidRow(width=12,
                                     ...
                                     column(9,
                                            div( 
                                             h3 ("Label Identifier"),
                                             "This option allows users to specify if phosphatases are labeled by coralID, uniprot, ensemble, entrez, 
                                             or HGNC ID.",
                                             
                                             h3 ("Font"),
                                             "Sets the font for all phosphatase labels, family labels, and titles in the Tree plot. ",
                         
                                             h3 ("Label Font Size"),
                                             "Sets the font size for all phosphatase labels, family labels, and titles. 
                                             This setting will apply to all plots.",
                         
                                             h3 ("Label Color Scheme"),
                                             "This option allows you to change the phosphatase label colors either uniformly or based on branch color.",
                         
                                             h4 (HTML("\u25be&nbsp;&nbsp; Single Color")),
                                             "The default option is to use the same color (black) for all phosphatase labels. 
                                             ...
                                             "This option colors the phosphatase labels the same as their branches. 
                                             This can work especially well when nodes are disabled and you are highlighting
                                             phosphatases in specific qualitative groups or quantitative extremes.",
        ...
        fluidRow(width=12,
                 ...
                 column(6,        
                        div(
                            ...
                            highlighting specific phosphatases when node and branch colors are already conveying important information.",
                      
                            h4 ("Phosphatases"),
                            "In this field you can list phosphatases you wish to highlight with node strokes. Each phosphatase must be separated by a new line.",
                            ...
                            "Here you can change the node stroke colors for both your selected and unselected phosphatases. Selected Color sets the stroke color  
                            of the phosphatases you have identified in the above field; Not Selected Color sets the stroke color for all other nodes.
