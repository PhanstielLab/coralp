        ...
        fluidRow(width=12, 
                 column(8, 
                        div(
                            ...
                            "This option allows you to color phosphatase branches based on a range of qualitative values. It is a useful 
                            ...
                            fluidRow(width=12,
                                     ...
                                     column(9,        
                                            div(
                                                ...
                                                have a value, or plotting will fail. Listing the same phosphatase multiple times with different 
                                                values will result in the branch being sized according to the last listed value. Identifiers 
                                                not found within the tree will be ignored. phosphatases that are not listed will lack a node entirely.",
                                                ...
                                                'phosphatases & Group' will be scaled to these minimum and maximum sizes.",
                                                
                                                h3 ("Missing phosphatases"),
                                                "Nodes for phosphatases that are not listed in the 'phosphatases & Value' field are automatically included
