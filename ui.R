...
ui <- dashboardPage(title="CORAL",
                    dashboardHeader(title = tags$a(span(img(src="logos/coralp-logo-white.png",height=60,align="left")),href="http://phanstiel-lab.med.unc.edu/CORAL/"),titleWidth = 600,
                                                        ...
                                                        box(width=12,title = "Node Size",status = "info", solidHeader = TRUE,
                                                            ...
                                                            conditionalPanel(
                                                             ...
                                                             conditionalPanel(
                                                              ...
                                                              sliderInput("size_node_single", "Size",value=8.5,min = 0,max=20,step = 0.25)
                                                             ),
                                                        ...
                                                        box(width=12,
                                                            ...
                                                            conditionalPanel(
                                                             ...
                                                             conditionalPanel(condition = "input.fontcolorselect == 'Single Color'|| input.fontcolorselect == 'Same as Branch'",
                                                                              ...
                                                                              sliderInput("fontsize", "Label Font Size",min = 0, max = 14,value = 7,step = 0.05,ticks=F)),
